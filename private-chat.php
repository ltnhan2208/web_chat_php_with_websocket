<?php 
	...
	else
	{
		...
		$list_user = $user_object->get_all_user_status_count();
	}
?>
<!DOCTYPE html>
<html>
						...
						<?php
							foreach($list_user as $value)
							{
								...
								if($value['user_id']!=$_SESSION['user']['user_id'])
								{
									...
									{
										echo '<li><span>'.$value['user_name'].'('.$value['count_status'].')</span><i class="fas fa-circle '.$color_status.'">&nbsp;'.$text_status.'</i></li>';
									} 
									else
									{
